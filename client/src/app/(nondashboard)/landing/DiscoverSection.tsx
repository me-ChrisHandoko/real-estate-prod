      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
            ...
            your search today adn discover your dream rental property!
          </p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap16 text-center">
          {[
            {
            ...
            },
            {
              ...
              description: "Move into yor new rental property and start enjoying your dream home.",
            },
          ].map((card, index) => (
